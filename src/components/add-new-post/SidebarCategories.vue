    ...
    <d-card-body class="p-0">
      <d-list-group flush>
        ...
        <d-list-group-item class="px-3 pb-2">
          ...
          <d-checkbox class="mb-1" value="design">News</d-checkbox>
          <d-checkbox class="mb-1" value="development">Development</d-checkbox>
          <d-checkbox class="mb-1" value="writing">Malaysia</d-checkbox>
          <d-checkbox class="mb-1" value="books">IR4.0</d-checkbox>
        </d-list-group-item>
